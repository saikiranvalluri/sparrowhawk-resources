...
num_word=100000
lm_dir="data/lm_webseed_added_dev4repl"
arpa_dir="data/arpa_webseed_added_dev4repl"
textdir="data/text_webseed_added_dev4repl"
...
for order in 3; do
  ...
  train_lm.py --num-words=${num_word} --wordlist=${wordlist} --num-splits=5 --warm-start-ratio=10 ${max_memory} \
